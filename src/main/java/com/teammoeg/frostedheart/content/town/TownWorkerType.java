...
public enum TownWorkerType {
    ...
    HOUSE(FHBlocks.HOUSE::get, (town, workData) -> {
        ...
        for(ItemResourceType foodType : foodTypes){
            SimpleResourceActionResult result = town.getResourceManager().costHighestLevelToEmpty(foodType, residentNum);
        ...
        for(ItemResourceType foodType : foodTypes){
            SimpleResourceActionResult result = town.getResourceManager().costHighestLevelToEmpty(foodType, toCost);
